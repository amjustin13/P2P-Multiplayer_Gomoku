git#Easiest Way to Create Board
CreateBoard = []
for x in range(0,9):
...
while True:
    ...
    print_board(CreateBoard)
        ...
        print("Please select a different spot")
...
'''print("Welcome to P2P-Multiplayer_Gomoku")
...
'''while True:
    ...
    ChooseColor = input("Please select color, 1 for black or 2 for white: ")
    if ChooseColor == 1:
        print(Player1, ':Black ')
        print(Player2, ':White')
    if ChooseColor == 2:
        ...
        print(Player1, 'Please enter a value color selection, 1 for black or 2 for white')
        break'''
...
#i = 19
#j = 19
#gameboard = [[0 for x in range(i)] for y in range(j)]
#for i <= 19:
#    print("*")
#        for j <= 19:
#        print("*")
